class MyHeader extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <header
    class="h-[100px] shadow-md bg-white flex items-center px-6 mb-10 sm:justify-between"
  >
    <!-- starbucks logo -->
    <a href="#" class="w-[51px] h-[51px]">
      <svg
        class="block"
        focusable="false"
        height="100%"
    ...
    <nav class="hidden gap-x-6 ml-8 xl:flex">
      <a
        class="text-sm font-bold hover:text-primary h-24 flex items-center leading-5 tracking-widest"
        href="#"
        >MENU</a
      >
      <a
    ...
    <nav class="hidden ml-auto items-center gap-x-4 xl:flex">
      <a
        href="#"
        class="text-sm font-semibold hover:text-primary flex items-center gap-x-2.5 mr-4"
      >
        <svg
          aria-hidden="true"
          ...
          style="width: 25px; height: 25px; overflow: visible; fill: currentColor"
          viewBox="0 0 24 24"
        >
          <path
      ...
      <a
        href="#"
        class="h-8 border border-secondary/70 flex items-center font-semibold hover:bg-gray transition-all rounded-full px-4 text-sm"
      >
        Sing in
      </a>
      <a
        href="#"
        class="h-8 border bg-secondary text-white flex items-center font-semibold hover:opacity-70 transition-all rounded-full px-4 text-sm"
      >
        Join now
      </a>
    </nav>
    <!-- hamburger menu -->
    <button class="relative group xl:hidden" id="hamburger-menu">
      <div
        class="relative flex overflow-hidden items-center justify-center rounded-full w-[40px] h-[40px] transform transition-all bg-transparent duration-200 hover:bg-gray/80"
      >
        <div
          class="flex flex-col justify-between w-[20px] h-[20px] transform transition-all duration-300 origin-center overflow-hidden"
        >
          <div
            class="bg-primary h-[2px] w-7 transform transition-all duration-300 origin-left group-focus:translate-x-10"
          ></div>
          <div
            class="bg-primary h-[2px] w-7 rounded transform transition-all duration-300 group-focus:translate-x-10 delay-75"
          ></div>
          <div
            class="bg-primary h-[2px] w-7 transform transition-all duration-300 origin-left group-focus:translate-x-10 delay-150"
          ></div>
          <div
          ...
          >
            <div
              class="absolute bg-primary h-[2px] w-5 transform transition-all duration-500 rotate-0 delay-300 group-focus:rotate-45"
            ></div>
            <div
              class="absolute bg-primary h-[2px] w-5 transform transition-all duration-500 -rotate-0 delay-300 group-focus:-rotate-45"
            ></div>
    ...
    <div
      class="fixed top-[100px] right-0 w-64 h-full bg-white transform translate-x-full transition-transform duration-200 ease-in-out overflow-auto"
      id="menu"
    >
      <a
        class="text-sm font-bold hover:text-primary h-24 flex items-center justify-center leading-5 tracking-widest"
        href="#"
        >MENU</a
      >
      <a
...
class MyFooter extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `<footer class="mt-10 pt-10 border-t-2 border-secondary/10 px-10">
      <div class="flex flex-col lg:grid lg:grid-cols-6">
        <nav>
          <h3 class="text-xl mb-4 dropdown-header">About Us</h3>
          <ul class="dropdown-menu">
            <li>
              <a class="text-secondary/50 hover:text-secondary py-3 block" href="#"
                >Our Company</a
              >
            </li>
            <li>
        ...
        <nav>
          <h3 class="text-xl mb-4 dropdown-header">Careers</h3>
          <ul class="dropdown-menu">
            <li>
              <a class="text-secondary/50 hover:text-secondary py-3 block" href="#"
        ...
        <nav>
          <h3 class="text-xl mb-4 dropdown-header">Social Impact</h3>
          <ul class="dropdown-menu">
            <li>
              <a class="text-secondary/50 hover:text-secondary py-3 block" href="#"
                >People</a
        ...
        <nav>
          <h3 class="text-xl mb-4 dropdown-header">For Business Partners</h3>
          <ul class="dropdown-menu">
            <li>
              <a class="text-secondary/50 hover:text-secondary py-3 block" href="#"
        ...
        <nav>
          <h3 class="text-xl mb-4 dropdown-header">Order and Pickup</h3>
          <ul class="dropdown-menu">
            <li>
              <a class="text-secondary/50 hover:text-secondary py-3 block" href="#"
                >Order on the App</a
      ...
      <!-- social media icons -->
      <div class="border-t-2 grid gap-y-6 pb-10 border-secondary/10 pt-12 mt-12">
        <nav class="flex gap-4">
          <!-- spotify icon -->
          <a
            href="#"
            class="w-8 h-8 bg-white rounded-full flex items-center justify-center text-secondary ring-0 hover:ring-8 hover:ring-secondary/10 transition-all"
          >
            <svg
              aria-hidden="true"
        ...
        <nav class="flex gap-x-6">
          ...
          >
          |
          <a href="#" class="hover:underline">CA Supply Chain Act</a>
          |
